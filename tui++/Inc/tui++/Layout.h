...
public:
  ...
  virtual std::optional<Dimension> get_minimum_layout_size(const std::shared_ptr<const Component> &target) = 0;

  virtual std::optional<Dimension> get_maximum_layout_size(const std::shared_ptr<const Component> &target) = 0;

  virtual std::optional<Dimension> get_preferred_layout_size(const std::shared_ptr<const Component> &target) = 0;
